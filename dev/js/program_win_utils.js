...
const winUtils = [
	{
		name: "Node.js",
		logo: "assets/img/winUtil-nodejsLogo.svg",
	...
	},
	{
		...
		logo: "assets/img/winUtil-windowsTerminalLogo.svg",
		...
		configs: [
			{
				...
				steps: [
					{
						explain:
							"Click to down triangle in tittle bar, and choose Settings or press <kbd>Ctrl</kbd> + <kbd>,</kbd>",
					},
					{
					...
					{
						explain:
							"In <q>Profiles</q> area click on <q>Windows PowerShell</q>, then go to <q>Appearance</q> tab and choose the color scheme <q>Campbell Powershell</q> for last change the font face to <q>Consolas</q>.",
					},
					{
						explain:
					...
					{
						explain:
							"In <q>Profiles</q> area, click in <q>Ubuntu</q> click on <q>Appearance</q> tab and choose the color scheme <q>Campbell</q> then change the font face to <q>Cascadia code</q>.",
	...
	{
		name: "HeidiSQL",
		logo: "assets/img/winUtil-heidySqlLogo.svg",
	...
	{
		name: "Mysql Comunity",
		logo: "assets/img/winUtil-mysqlLogo.svg",
		...
		configs: [
			{
				instruction:
					"** Verify and uninstall if <q>Mysql installer - Community</q> is installed on your system, and be carefully <strong>not use the web version</string> of the installer (mysql-installer-web-community-X.X.X.msi)",
			},
		],
	},
	{
		name: "Git (GitBash)",
		logo: "assets/img/winUtil-gitBashLogo.svg",
		...
		configs: [
			{
				...
				steps: [
					...
					{
						explain:
							"To test Visual Studio Code as your default editor, the next command open global .gitconfig file into Visual Studio Code.",
						code: "git config --global -e",
					},
					{
						explain:
							"To set Visual Studio Code as your difftool, you need to go into global git config file. Which you can access through previous mentioned command <code>git config --global -e</code> then you need to add those entries (or replace existing ones) and save the changes.",
	...
	{
		name: "Sourcetree",
		logo: "assets/img/winUtil-sourcetreeLogo.svg",
		...
		configs: [
			{
				instruction:
					"May be you like to setup soircetree too, this is possible in <q>Tools</q> menu and selecting options",
				steps: [
					{
					...
					{
						explain:
							"To setup Github, bitbucket and/or other accounts go to <q>Authentication</q> tab to select and connect your services. ",
					},
				],
			},
		],
	...
	{
		name: "GitHub Desktop",
		logo: "assets/img/winUtil-githubDesktopLogo.svg",
	...
	{
		name: "XAMPP",
		logo: "assets/img/winUtil-xamppLogo.svg",
		...
		configs: [
			{
				instruction:
					"Maybe you want to configure any or all next configurations. You need to search for a files and change some parameters.",
				steps: [
					{
						explain:
							'<q>httpd.conf</q> file to change the <code>DocumentRoot</code> and <code>&lt;Directory "c:/path/to/files"&gt;</code> paths. That\'s the folders where you will serve your documents.',
					},
					{
						explain:
							"<q>config.inc.php</q> to change the mysql/mariaDB login to request DB server user and password. Search and set the <q>auth_type</q> to <q>cookie</q>",
						code: "$cfg['Servers'][$i]['auth_type'] = 'cookie';",
					},
					{
						explain:
							'Download a <a target="_blank" href="downloads/cert_localhost.cmd" download>command line</a> script to create an https certificate for https://localhost (instructions in spanish)',
					},
					{
						explain:
							'Download special <a target="_blank" href="downloads/folder_cert.cmd" download>command line</a> script for create an https certificate for a folders from above <q>DocumentRoot</q> path with a personalized domain (instructions in spanish).',
					},
					{
						explain:
							'If you want add PHP to your system path, use PowerShell with administrator privileges, paste next code where	<code class="inline">c:\\path\\to\\php_folder\\</code> is your php.exe file folder.',
